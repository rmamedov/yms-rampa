...
- Name: 12-admin-store-card.spec.ts >> A-05 Вкладка «Слоти» >> A-05.8 номер рампи менший за 1 відхиляється
- Location: tests/12-admin-store-card.spec.ts:619:7
...
Expected substring: "Номер рампи — ціле число ≥ 1"
        ...
        - generic [ref=f1e54]:
          ...
          - table [ref=f1e58]:
            ...
            - rowgroup [ref=f1e65]:
              - row [ref=f1e66]:
                - cell [ref=f1e67]:
                  - spinbutton [active] [ref=f1e68]: "0"
                - cell [ref=f1e69]:
                  - textbox "Рампа №0" [ref=f1e70]: Рампа 1
                - cell [ref=f1e71]:
              ...
              - row [ref=f1e76]:
                - cell [ref=f1e77]:
                  - spinbutton [ref=f1e78]: "2"
                - cell [ref=f1e79]:
                  - textbox "Рампа №2" [ref=f1e80]: Рампа 2
                - cell [ref=f1e81]:
