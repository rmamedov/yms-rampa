...
/**
 * Друга цілодобова філія (6 рамп, слот 15 хв) — запас слотів для довгих
 * прогонів. З двома рампами вікно відмітки давало лише 8 придатних слотів
 * на годину, і повний прогін їх вичерпував: тест тач-цілей падав не через
 * дефект, а тому що не лишалося слоту з відкритим вікном.
 *
 * Порядок у переліку = порядок вибору: спершу пробуємо ту, де слотів більше.
 */
export const ARRIVAL_SANDBOX_EXTERNAL_IDS = ['2233', '2231'] as const;
